<script>
	import { onMount } from 'svelte'; import { api } from '$lib/api.js'; import Nav from '$lib/Nav.svelte'; import SkeletonTable from '$lib/SkeletonTable.svelte'; import { formatCurrency } from '$lib/format.js';
